...
# --- tfpilot:begin:req_dev_s3_8df5g5 ---
module "tfpilot_req_dev_s3_8df5g5" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-8df5g5"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_8df5g5"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_8df5g5"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_8df5g5"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
...
# --- tfpilot:end:req_dev_s3_8df5g5 ---
# --- tfpilot:begin:req_dev_s3_e5qpt5 ---
module "tfpilot_req_dev_s3_e5qpt5" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-e5qpt5"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_e5qpt5"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_e5qpt5"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_e5qpt5"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
...
# --- tfpilot:end:req_dev_s3_e5qpt5 ---
# --- tfpilot:begin:req_dev_s3_fpnypc ---
module "tfpilot_req_dev_s3_fpnypc" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-fpnypc"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_fpnypc"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_fpnypc"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_fpnypc"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
