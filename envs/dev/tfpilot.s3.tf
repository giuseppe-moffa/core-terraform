...
# --- tfpilot:begin:req_dev_s3_8r9xml ---
module "tfpilot_req_dev_s3_8r9xml" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-8r9xml"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_8r9xml"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_8r9xml"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_8r9xml"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
...
# --- tfpilot:begin:req_dev_s3_799em7 ---
module "tfpilot_req_dev_s3_799em7" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-799em7"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_799em7"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_799em7"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_799em7"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
...
# --- tfpilot:end:req_dev_s3_799em7 ---
# --- tfpilot:begin:req_dev_s3_aew9yl ---
module "tfpilot_req_dev_s3_aew9yl" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-aew9yl"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_aew9yl"
  versioning_enabled = true
  force_destroy = false
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_aew9yl"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_aew9yl"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-private-secure"
