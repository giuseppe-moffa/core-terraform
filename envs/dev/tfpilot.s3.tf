...
# --- tfpilot:begin:req_dev_s3_hxq9yx ---
module "tfpilot_req_dev_s3_hxq9yx" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-hxq9yx"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_hxq9yx"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_hxq9yx"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_hxq9yx"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
