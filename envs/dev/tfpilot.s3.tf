...
# --- tfpilot:begin:req_dev_s3_cndwa6 ---
module "tfpilot_req_dev_s3_cndwa6" {
  source = "../../modules/s3-bucket"
  name = "core-dev-ai-agent-cndwa6"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_cndwa6"
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_cndwa6"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_cndwa6"
...
# --- tfpilot:begin:req_dev_s3_awvkgn ---
module "tfpilot_req_dev_s3_awvkgn" {
  source = "../../modules/s3-bucket"
  name = "core-dev-ai-agent-awvkgn"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_awvkgn"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_awvkgn"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_awvkgn"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
