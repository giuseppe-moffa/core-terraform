...
# --- tfpilot:begin:req_dev_s3_py6xex ---
module "tfpilot_req_dev_s3_py6xex" {
  source = "../../modules/s3-bucket"
  name = "public-assets-py6xex"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_py6xex"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_py6xex"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_py6xex"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
