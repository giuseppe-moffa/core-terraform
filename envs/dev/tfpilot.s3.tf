...
# --- tfpilot:begin:req_dev_s3_c4xjfc ---
module "tfpilot_req_dev_s3_c4xjfc" {
  source = "../../modules/s3-bucket"
  name = "ai-agent-c4xjfc"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_c4xjfc"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_c4xjfc"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_c4xjfc"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
