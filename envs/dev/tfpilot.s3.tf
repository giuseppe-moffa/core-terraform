...
# --- tfpilot:begin:req_dev_s3_54m3df ---
module "tfpilot_req_dev_s3_54m3df" {
  source = "../../modules/s3-bucket"
  name = "core-dev-ai-agent-54m3df"
  project = "core"
  environment = "dev"
  request_id = "req_dev_s3_54m3df"
  versioning_enabled = false
  force_destroy = true
  block_public_access = true
  enable_lifecycle = false
  ...
  tags = {
    ManagedBy = "tfpilot"
    TfPilotRequestId = "req_dev_s3_54m3df"
    Project = "core"
    Environment = "dev"
    "tfpilot:request_id" = "req_dev_s3_54m3df"
    "tfpilot:project" = "core"
    "tfpilot:environment" = "dev"
    "tfpilot:created_by" = "giuseppe-moffa"
    "tfpilot:template_id" = "s3-public-assets"
